enum ledStates {MORSE, INCREASE, DECREASE, STAY, WAVE, OFF, ON}; // Here we make nicknames for the different states our program supports.
 ...
 bool doing = true;
  ...
  while(doing){
    ...
    if (currentMillis - startMillis <= 250){
      brightness = 255;
      } else if(currentMillis - startMillis >250 && currentMillis - startMillis < 500){
        brightness =0;
